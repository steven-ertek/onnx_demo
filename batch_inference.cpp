...
int main(int argc, char* argv[]) {
    ...
    try {
        ...
        std::cerr << "========================================" << std::endl;
        std::cerr << "ONNX Runtime Error" << std::endl;
        std::cerr << "========================================" << std::endl;
        std::cerr << "Message: " << ex.what() << std::endl;
        std::cerr << "Code: " << ex.GetOrtErrorCode() << std::endl;
        std::cerr << "\nPossible causes:" << std::endl;
        std::cerr << "- Invalid model file or unsupported ONNX version" << std::endl;
        std::cerr << "- Incompatible input/output shapes" << std::endl;
        std::cerr << "- Missing ONNX Runtime dependencies" << std::endl;
        std::cerr << "========================================" << std::endl;
        return 1;
